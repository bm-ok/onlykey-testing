...
| section 2 | 84 passed, 0 failed (gadget) | skipped - `client-access`, the kit's adapter holds the nodes the CLI needs |
| section 3 | 72 passed, 0 failed (headless 50 + browser 22) | n/a - both tiers drive the emulator by design |
| **whole tree** | **274 passed** | **96 passed, 9 skipped-with-reason** |
