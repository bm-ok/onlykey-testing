...
function detect({ adapter = 'emulated' } = {}) {
  ...
  add('kernel-hid', !emulated,
    'emulated mode opens no /dev/hidraw; anything reaching the device through ' +
    'hidapi (python-onlykey, lib-agent, node-hid) belongs to a later section');
